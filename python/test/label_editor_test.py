...
import boto3
from src.label_editor import lambda_handler

# Percorso assouluto per caricare il file event.json
absolute_path = os.path.dirname(os.path.abspath(__file__))
file_path1 = absolute_path + '/../event/label_editor_true_event.json'

file_path2 = absolute_path + '/../event/label_editor_false_event.json'

file_path3 = absolute_path + '/../event/label_editor_exception_event.json'
...
CONTEXT.function_name = 'label_editor'


class TestLabelEditor(unittest.TestCase):
    """
    Classe di test per il lambda_handler di label_editor
    """
